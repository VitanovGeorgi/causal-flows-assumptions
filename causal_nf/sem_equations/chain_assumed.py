    ...
    def __init__(self, sem_name):
        ...
        if sem_name == "linear":
            functions = [
                ...
                lambda x1, u2: u2,
                lambda x1, x2, u3: u3,
                lambda x1, x2, x3, u4: 10 * x3 - u4,
                lambda x1, x2, x3, x4, u5: 0.25 * x4 + 2 * u5,
            ]
            inverses = [
                lambda x1: x1,
                lambda x1, x2: x2,
                lambda x1, x2, x3: x3,
                lambda x1, x2, x3, x4: (10 * x3 - x4),
                lambda x1, x2, x3, x4, x5: (x5 - 0.25 * x4) / 2,
            ]
