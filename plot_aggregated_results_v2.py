...
parser.add_argument(
    ...
    default="output_causal_nf/aggregated_results/results_chain_2024-09-24"
)
parser.add_argument("--target", help="output file path", default="output_aggregated_results/chain")
