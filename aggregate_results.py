...
if __name__ == "__main__":
    ...
    for key in all_experiments_logs.keys():
        ...
        # all_experiments_logs[key]['loss'] = all_experiments_params[key]['dataset'].get('loss', None)
        # all_experiments_logs[key]['name'] = all_experiments_params[key]['dataset'].get('name', None)
        # all_experiments_logs[key]['num_samples'] = all_experiments_params[key]['dataset'].get('num_samples', None)
        # all_experiments_logs[key]['sem_name'] = all_experiments_params[key]['dataset'].get('sem_name', None)
        # all_experiments_logs[key]['steps'] = all_experiments_params[key]['dataset'].get('steps', None)
        # all_experiments_logs[key]['seed'] = all_experiments_params[key]['seed']
